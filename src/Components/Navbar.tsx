...
<ul className={`flex flex-col gap-5 m font-sans ${isopen?'translate-x-48':'translate-x-0'} bg-slate-300 px-3 py-2 font-medium text-2xl fixed right-0 top-20 md:flex-row md:relative md:top-0`}>
    <li>Home</li>
    <li>Find Receipe</li>
    <li>Buy</li>
</ul>
...
<svg className={`block cursor-pointer md:hidden`} onClick={handleClick} width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
